            ...
            for i in range(self.config['num_configs']['default']):
                ...
                if valid_config:
                    ...
                    if mse < best_mse:
                        ...
                        self.model_logger.info(f"Current MSE {mse:.2f} is better than previous best MSE {best_mse:.2f}.")
                        best_cfg = config
                        best_mse = mse
                    else:
                        print(f"Current MSE {mse:.2f} is NOT better than previous best MSE {best_mse:.2f}.")
                        self.model_logger.info(f"Current MSE {mse:.2f} is NOT better than previous best MSE {best_mse:.2f}.")
