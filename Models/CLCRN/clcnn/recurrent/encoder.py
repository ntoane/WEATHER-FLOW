...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, sparse_idx, angle_ratio, geodesic, conv_ker, modelConfig, horizon):
        nn.Module.__init__(self)
        Seq2SeqAttrs.__init__(self, sparse_idx, angle_ratio, geodesic, modelConfig, horizon)
        self.conv = conv_ker
