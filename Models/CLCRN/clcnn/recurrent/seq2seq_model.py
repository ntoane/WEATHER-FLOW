...
class CLCRNModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, loc_info, sparse_idx, geodesic, modelConfig, horizon, angle_ratio, logger=None):
        '''
    ...
    modelConfig (dict): Other model args see the config.yaml.
        '''
        super().__init__()
        Seq2SeqAttrs.__init__(self, sparse_idx, geodesic, angle_ratio, modelConfig, horizon)
        ...
        self.encoder_model = EncoderModel(sparse_idx, geodesic, angle_ratio, self.conv_ker, modelConfig, horizon)
        self.decoder_model = DecoderModel(sparse_idx, geodesic, angle_ratio, self.conv_ker, modelConfig, horizon)
        self.cl_decay_steps = modelConfig['cl_decay_steps']['default']
