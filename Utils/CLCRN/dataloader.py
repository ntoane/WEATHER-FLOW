...
from Models.manifold.sphere import Sphere
...
def load_dataset(dataset_dir, split, batch_size, position_file, val_batch_size=None, include_context=False, **kwargs):
    ...
    train_set = Dataset(
        dataset_dir, split, mode='trn', batch_size=batch_size, scaler=scaler, include_context=include_context
    )

    validation_set = Dataset(
        dataset_dir, split, mode='val', batch_size=val_batch_size, scaler=scaler, include_context=include_context
    )

    test_set = Dataset(
        dataset_dir, split, mode='test', batch_size=val_batch_size, scaler=scaler, include_context=include_context
    )
